 ...
 *
 * Used by [tech.fika.monaka.plugin.Plugin.onError] to give plugins enough
 * context to log or report an error meaningfully.
 *
 * Five variants cover every place the runtime calls a handler lambda:
 * - [Action]     — an action dispatched via [tech.fika.monaka.core.Store.dispatch].
 * - [Lifecycle]  — an application lifecycle event forwarded via
 *                  [tech.fika.monaka.core.Store.onLifecycleEvent].
