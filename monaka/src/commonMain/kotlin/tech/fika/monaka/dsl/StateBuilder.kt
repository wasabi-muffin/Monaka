 ...
 *   corresponding [LifecycleEvent] is forwarded via [tech.fika.monaka.core.Store.onLifecycleEvent]
...
class StateBuilder<State : StateMarker, SubState : State, Action : ActionMarker, Effect : EffectMarker> {
     ...
     * [tech.fika.monaka.plugin.Plugin.onError] and no further recovery is attempted.
     *
     * ```kotlin
     * state<MyState.Loading> {
     *     onEnter {
